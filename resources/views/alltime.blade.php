    ...
    <div class="container">
        <div class="columns">
            <div class="column is-6">
                <h1>All Time Best</h1>
                <h2>The coins with the most votes over all time</h2>
            </div>
            <div class="column is-6">
                <div class="pro">
                    <a href="{{\App\Advertisement::where(['id' => 2])->pluck('referral_url')->first()}}" class="pro-image" target="_blank">
                        <img src="{{\App\Advertisement::where(['id' => 2])->pluck('image_url')->first()}}" alt="" class="is-hidden-mobile">
                        <img src="{{\App\Advertisement::where(['id' => 2])->pluck('image_url')->first()}}" alt="" class="is-hidden-tablet">
                    </a>
