    ...
    <div class="container">
        <div class="columns">
            <div class="column is-6">
                <h1>Coins In Presale Phase</h1>
                <h2>These coins are still in presale phase</h2>
            </div>
            <div class="column is-6">
                <div class="pro">
                    <a href="{{\App\Advertisement::where(['id' => 5])->pluck('referral_url')->first()}}" class="pro-image" target="_blank">
                        <img src="{{\App\Advertisement::where(['id' => 5])->pluck('image_url')->first()}}" alt="" class="is-hidden-mobile">
                        <img src="{{\App\Advertisement::where(['id' => 5])->pluck('image_url')->first()}}" alt="" class="is-hidden-tablet">
                    </a>
        ...
        <div class="message error light">
            <p>
                These projects are still in presale phase. Be careful when investing into presales - these projects are very new and scams can happen.
                For more information how to spot scams, please read our article <a href="{{ route('anti-scam-guide') }}">How To Spot Scams</a>.
            </p>
        </div>
