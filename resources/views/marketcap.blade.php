    ...
    <div class="container">
        <div class="columns">
            <div class="column is-6">
                <h1>Coins By Marketcap</h1>
                <h2>From the biggest winners to the smallest gems</h2>
            </div>
            <div class="column is-6">
                <div class="pro">
                    <a href="{{\App\Advertisement::where(['id' => 4])->pluck('referral_url')->first()}}" class="pro-image" target="_blank">
                        <img src="{{\App\Advertisement::where(['id' => 4])->pluck('image_url')->first()}}" alt="" class="is-hidden-mobile">
                        <img src="{{\App\Advertisement::where(['id' => 4])->pluck('image_url')->first()}}" alt="" class="is-hidden-tablet">
                    </a>
        ...
        <div class="listings">
            <table class="table is-fullwidth is-striped">
                ...
                <tr>
                    ...
                    <th class="is-hidden-tablet mcap-header">Marketcap</th>
                    <th class="is-hidden-mobile">Vote<span class="is-hidden-tablet">s</span></th>
                </tr>
                </thead>
                <tbody>

                @foreach($marketcap as $nw)
